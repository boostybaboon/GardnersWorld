...
void GWDocument::updateCommandStack(GWCommand& gwc)
{
    ...
    {
        //if no parent, assume it needs adding to command stack in the DOM (otherwise we should be doing an undo or redo
        //in which case this node will already be part of the DOM)
