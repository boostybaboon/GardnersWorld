...
typedef struct _AffectedNodeInfo_
{
    QSharedPointer<GWNode> _affectedNode;
    GWSceneGraphPosition _preCommandPos;
...
public:
    ...
    virtual QVector<AffectedNodeInfo> getAffectedNodes() const = 0;
...
public:
    ...
    QVector<AffectedNodeInfo> getAffectedNodes() const;
