...
void GWMainWindow::on_actionTrackball_activated()
{
    //set the trackball input handler on the active view
    GW3dViewWidget* viewWidget3d = getActive3dViewWidget();
    if(viewWidget3d)
    {
        viewWidget3d->activateTrackballMode();
    }
}

void GWMainWindow::on_actionSelect_activated()
{
    //set the select input handler on the active view
    GW3dViewWidget* viewWidget3d = getActive3dViewWidget();
    if(viewWidget3d)
    {
        viewWidget3d->activateSelectMode();
    }
}

void GWMainWindow::on_actionManipulate_activated()
{
    //set the select input handler on the active view
    GW3dViewWidget* viewWidget3d = getActive3dViewWidget();
    if(viewWidget3d)
    {
        viewWidget3d->activateManipulateMode();
    }
}
...
GW3dViewWidget* GWMainWindow::getActive3dViewWidget()
{
    //obviously need to do more than this when there are multiple views
    return _gw3dViewWidget;
}
