...
void GW3dViewWidget::activateTrackballMode()
{
    _gw3dView->activateTrackballMode();
}

void GW3dViewWidget::activateSelectMode()
{
    _gw3dView->activateSelectMode();
}

void GW3dViewWidget::activateManipulateMode()
{
    //_gw3dView->activateManipulateMode();
}
